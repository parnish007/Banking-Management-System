...
\usepackage{tabularx}
\usepackage{times}
% use \linespread for line spacing to avoid missing setspace package
\usepackage{titlesec}
\usepackage{enumitem}
\usepackage{listings}
...
\date{27 July 2026}
\newcommand{\coursecode}{ENGG 102}
\newcommand{\yeargroup}{I}
\newcommand{\semester}{II}
\newcommand{\groupname}{Computer Engineering}
\newcommand{\memberA}{Trilochan Sharma}
\newcommand{\memberB}{Ujjwal Upadhaya}
\newcommand{\memberC}{Aadarsh Prasad}
\newcommand{\memberD}{Saurav Shah}
\newcommand{\supervisorname}{Aayush Paudel}
\newcommand{\submittedto}{Suman Shrestha}
\newcommand{\coordinatorname}{Department Coordinator}
\newcommand{\departmentname}{Department of Computer Science and Engineering}

\begin{document}
% Relax line-breaking to reduce remaining overfull boxes in verbatim/table outputs
\sloppy
...
\begin{titlepage}
  ...
  {\large Submitted to: \\ \submittedto \\ \departmentname}\\[0.6cm]
  {\large Coordinator: \\ \coordinatorname \\ \departmentname}\\[1cm]
  {27 July 2026}
\end{titlepage}

% Insert bona fide certificate (contains supervisor/coordinator signatures)
\cleardoublepage
\input{chapters/bonafide.tex}
...
% Figure removed per request (was image4.png)
...
% Render console output smaller and allow flexible line breaking to avoid overfull boxes
% Console transcript: scale down to text width to avoid overfull boxes
% Render console output smaller and allow flexible line breaking to avoid overfull boxes
\begingroup
\small
\ttfamily
...
% Nicely formatted tables for the transcript (replaces long ASCII tables)
\begin{table}[H]
  \centering
  \small
  \begin{tabularx}{\textwidth}{l l l l r X}
    ...
    \hline
    1 & 2026-07-25 18:42:10 & ACC000002 & ACC000003 & \$150.00 & rent \\
    \hline
  \end{tabularx}
  \caption{Sample pending transactions shown in the console transcript.}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{l X l l r l}
    \hline
    ID & Name & Username & Account No. & Balance & Role \\
    \hline
    1 & Administrator & admin & -- & -- & admin \\
    2 & Alice Johnson & alice & ACC000002 & \$350.00 & user \\
    3 & Bob Sharma & bob & ACC000003 & \$650.00 & user \\
    \hline
  \end{tabularx}
  \caption{Sample users and accounts shown in the console transcript.}
\end{table}
